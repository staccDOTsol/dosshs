...
do 
 ...
 matches-cli drain_match   -k ~/.config/solana/id.json  -env mainnet-beta -cp ${1}/1.json
         matches-cli drain_oracle           -k ~/.config/solana/id.json -env mainnet-beta   -cp ${1}/1.json
